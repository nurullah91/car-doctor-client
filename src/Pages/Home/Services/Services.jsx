    ...
    return (
        <div>
            <div className="text-center space-y-5 my-10">
                ...
                <div className="flex w-11/12 lg:w-1/2 mx-auto">
                    ...
                    <button className="btn ml-3 btn-warning " onClick={() => setAscending(!ascending)}>Price:{ascending ? "High to low" : "Low to high"}</button>
                </div>
            </div>
